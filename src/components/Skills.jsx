...
const skills = [
  ...
  },
  {
    ...
    description: "My Experience in Bootstrap is Intermediate",
  },
  {
    name: "Tailwind css",
    icon: "fab fa-css3-alt",
    description: "My Experience in Tailwind css is Intermediate",
  },

  {
    name: "JavaScript",
    icon: "fa-brands fa-square-js",
    description: "My Experience in javascript is Intermediate.",
  },
  {
    name: "TypeScript",
    icon: "fab fa-js-square",
    description: "My Experience in TypeScript is Junior",
  },
  {
    name: "React",
    icon: "fab fa-react",
  ...
  },
  {
    name: "Vs Code",
    icon: "fas fa-code",
    description: "My Experience in vs code is Intermediate.",
  },
];
  ...
  return (
    <div>
      <div className="heading-card">
        <h1>My Skills</h1>
        <p>
          Below are the technologies that I have more or less experience with
        </p>
        <p></p>
      </div>
